...
public class EmissionButton : MonoBehaviour
{
    ...
    public Color onColor = Color.black; // Color when the button is pressed.
    public Color offColor = Color.white; // Color when the button is not pressed.
    ...
    void ToggleEmission(bool on)
    {
        if (targetRenderer != null)
        {
            ...
            Color targetColor = on ? offColor : onColor;
